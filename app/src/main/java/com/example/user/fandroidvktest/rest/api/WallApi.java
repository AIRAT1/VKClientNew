...
import com.example.user.fandroidvktest.rest.model.response.GetWallByIdResponse;
import com.example.user.fandroidvktest.rest.model.response.GetWallResponse;
