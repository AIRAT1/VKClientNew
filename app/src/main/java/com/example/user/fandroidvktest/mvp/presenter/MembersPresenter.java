...
import com.example.user.fandroidvktest.model.view.MemberViewModel;
import com.example.user.fandroidvktest.mvp.view.BaseFeedView;
import com.example.user.fandroidvktest.rest.api.GroupsApi;
import com.example.user.fandroidvktest.rest.model.request.GroupsGetMembersRequestModel;
