package com.example.user.fandroidvktest.ui.activity;
...
import com.example.user.fandroidvktest.common.BaseAdapter;
import com.example.user.fandroidvktest.consts.ApiConstants;
import com.example.user.fandroidvktest.event.SendCommentEventOnSubscribe;
import com.example.user.fandroidvktest.event.SendCreatedPostEventOnSubscribe;
import com.example.user.fandroidvktest.event.UploadFileEventOnSubscribe;
import com.example.user.fandroidvktest.event.UploadPhotoEventOnSubscribe;
import com.example.user.fandroidvktest.model.view.CreatePostTextViewModel;
...
import com.example.user.fandroidvktest.ui.dialog.AddAttachmentDialogFragment;
