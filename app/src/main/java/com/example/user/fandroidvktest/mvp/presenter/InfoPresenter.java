...
import com.example.user.fandroidvktest.model.view.InfoContactsViewModel;
import com.example.user.fandroidvktest.model.view.InfoLinksViewModel;
import com.example.user.fandroidvktest.model.view.InfoStatusViewModel;
import com.example.user.fandroidvktest.mvp.view.BaseFeedView;
import com.example.user.fandroidvktest.rest.api.GroupsApi;
import com.example.user.fandroidvktest.rest.model.request.GroupsGetByIdRequestModel;
