...
import com.example.user.fandroidvktest.model.view.counter.CommentCounterViewModel;
import com.example.user.fandroidvktest.model.view.counter.LikeCounterViewModel;
import com.example.user.fandroidvktest.model.view.counter.RepostCounterViewModel;
import com.example.user.fandroidvktest.rest.api.LikeEventOnSubscribe;
import com.example.user.fandroidvktest.rest.api.WallApi;
import com.example.user.fandroidvktest.rest.model.request.WallGetByIdRequestModel;
